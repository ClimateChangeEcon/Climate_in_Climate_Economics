...
### READING THE DATA from CDICE
path = '../DEQN_for_IAMs/dice_generic/optimal_results/IES2/Opt_mmm_mmm_psi2/'
...
## READING THE DATA from DICE16
path = '../DEQN_for_IAMs/dice_generic/optimal_results/IES2/Opt_dice16_psi2/'
...
## READING THE DATA from DICE16+ecs215
path = '../DEQN_for_IAMs/dice_generic/optimal_results/IES2/Opt_dice16_ecs215_psi2/'
...
### READING THE DATA from DICE16+ecs455
path = '../DEQN_for_IAMs/dice_generic/optimal_results/IES2/Opt_dice16_ecs455_psi2/'
...
path = '../DEQN_for_IAMs/dice_generic/optimal_results/IES2/Opt_mmm_giss_psi2/'
...
path = '../DEQN_for_IAMs/dice_generic/optimal_results/IES2/Opt_mmm_hadgem_psi2/'
...
### READING THE DATA from CDICE
path = '../DEQN_for_IAMs/dice_generic/optimal_results/IES05/Opt_mmm_mmm_psi05/'
...
## READING THE DATA from DICE16
path = '../DEQN_for_IAMs/dice_generic/optimal_results/IES05/Opt_dice16_psi05/'
...
## READING THE DATA from DICE16+ecs215
path = '../DEQN_for_IAMs/dice_generic/optimal_results/IES05/Opt_dice16_ecs215_psi05/'
...
### READING THE DATA from DICE16+ecs455
path = '../DEQN_for_IAMs/dice_generic/optimal_results/IES05/Opt_dice16_ecs455_psi05/'
...
### READING THE DATA from new CDICE + GISS
path = '../DEQN_for_IAMs/dice_generic/optimal_results/IES05/Opt_mmm_giss_psi05/'
...
### READING THE DATA from new CDICE + hadgem
path = '../DEQN_for_IAMs/dice_generic/optimal_results/IES05/Opt_mmm_hadgem_psi05/'
...
ax.plot(x, de_cdice_hadgem[0:tl], color='#20CBD1', ls='solid', linewidth=4, label='CDICE-HadGEM2-ES, psi=0.69')
ax.plot(x, de_cdice_hadgem_IES2[0:tl], color='#20CBD1', ls='dotted', linewidth=4, label='CDICE-HadGEM2-ES, psi=2.')
ax.plot(x, de_cdice_hadgem_IES05[0:tl], color='#20CBD1', ls='dashed', linewidth=4, label='CDICE-HadGEM2-ES, psi=0.5')

ax.plot(x, de_dice16_ecs455[0:tl], color='red', ls='solid', linewidth=1, label='DICE-2016, ECS=4.55, psi=0.69')
ax.plot(x, de_dice16_ecs455_IES2[0:tl], color='red', ls='dotted', linewidth=1, label='DICE-2016, ECS=4.55, psi=2.')
ax.plot(x, de_dice16_ecs455_IES05[0:tl], color='red', ls='dashed', linewidth=1, label='DICE-2016, ECS=4.55, psi=0.5')
...
ax.plot(x, de_cdice_giss[0:tl], color='#92F41C', ls='solid',linewidth=4, label='CDICE-GISS-E2-R, psi=0.69')
ax.plot(x, de_cdice_giss_IES2[0:tl], color='#92F41C', ls='dotted', linewidth=4, label='CDICE-GISS-E2-R, psi=2.')
ax.plot(x, de_cdice_giss_IES05[0:tl], color='#92F41C', ls='dashed', linewidth=4, label='CDICE-GISS-E2-R, psi=0.5')

ax.plot(x, de_dice16_ecs215[0:tl], color='green', ls='solid', linewidth=1, label='DICE-2016, ECS=2.15, psi=0.69')
ax.plot(x, de_dice16_ecs215_IES2[0:tl], color='green', ls='dotted', linewidth=1, label='DICE-2016, ECS=2.15, psi=2.')
ax.plot(x, de_dice16_ecs215_IES05[0:tl], color='green', ls='dashed', linewidth=1, label='DICE-2016, ECS=2.15, psi=0.5')
