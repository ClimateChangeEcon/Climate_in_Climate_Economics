...
path = '../DEQN_for_IAMs/gdice_baseline/bau_results/BAU_mesmo_hadgem/'
...
path = '../DEQN_for_IAMs/gdice_baseline/bau_results/BAU_mesmo_giss/'
...
path = '../DEQN_for_IAMs/gdice_baseline/bau_results/BAU_loveclim_hadgem/'
...
path = '../DEQN_for_IAMs/gdice_baseline/bau_results/BAU_loveclim_giss/'
...
ax.plot(x, de_loveclim_giss[0:tl], color='#92F41C', ls='dashed', linewidth=2, label='CDICE-LOVECLIM-GISS-E2-R')
ax.plot(x, de_loveclim_hadgem[0:tl], color='#20CBD1', ls='dashed', linewidth=3, label='CDICE-LOVECLIM-HadGEM2-ES')
ax.plot(x, rcp85[0:tl], color='red', ls='solid',  linewidth=4, label='RCP 8.5')
ax.plot(x, rcp60[0:tl], color='orange', ls='solid',  linewidth=6, label='RCP 6.0')
