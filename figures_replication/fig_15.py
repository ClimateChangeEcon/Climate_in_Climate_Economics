...
### READING THE DATA from BAU CDICE
...
### READING THE DATA from DICE16 BAU
...
### READING THE DATA from  BAU CDICE with DICE16 carbon cycle
path = '../DEQN_for_IAMs/gdice_baseline/bau_results/BAU_CDICE_with_DICE16CC/'
...
### READING THE DATA from BAU DICE16+ecs215
path = '../DEQN_for_IAMs/gdice_baseline/bau_results/BAU_dice2016_ecs215/'
...
### READING THE DATA from BAU DICE16+ecs455
path = '../DEQN_for_IAMs/gdice_baseline/bau_results/BAU_dice2016_ecs455/'
...
### READING THE DATA from BAU CDICE + GISS
path = '../DEQN_for_IAMs/gdice_baseline/bau_results/BAU_mmm_giss/'
...
### READING THE DATA from  BAU CDICE + hadgem
path = '../DEQN_for_IAMs/gdice_baseline/bau_results/BAU_mmm_hadgem/'
...
### READING THE DATA from  BAU CDICE + mesmo
path = '../DEQN_for_IAMs/gdice_baseline/bau_results/BAU_mmm_mesmo/'
...
### READING THE DATA from CDICE + loveclim
path = '../DEQN_for_IAMs/gdice_baseline/bau_results/BAU_mmm_loveclim/'
...
ax.plot(x, de_cdice_mesmo[0:tl], color='blue', ls='dotted', linewidth=4, label='CDICE-MESMO')
...
ax.plot(x, de_cdice[0:tl], color='blue', ls='solid', linewidth=4, label='CDICE')
ax.plot(x, de_dice16[0:tl], color='black', ls='solid', linewidth=1, label='DICE-2016')
ax.plot(x, de_dice16_mmm[0:tl], color='violet', ls='solid', linewidth=7, label='CDICE with carbon cycle from DICE-2016')
