...
F_ERCPE   = 'yes'  #plot carbon emissions for different hist+RCPs, emissions as input
F_FRCPE   = 'no'  #plot forcing for different hist+RCPs, emission fed, emissions as input
F_CRCPC   = 'yes'  #plot CO2 concentrations different hist+RCPs, CO2 concentrations as input
F_FRCPC   = 'yes'  #plot forcing for different hist+RCPs, emission fed, CO2 concentrations as input
