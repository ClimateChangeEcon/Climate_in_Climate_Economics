...
F_G13     = 'no'   #G13 test; Figs: temp.
F_G13S    = 'no'   #G13 param.sens; Figs: temp.
F_J13     = 'no'   #J13 test; Figs: mass frac. puls / CO2 conc. / temp.
F_J13M    = 'no'   #J13 test, modified DICE params; Figs: mass frac. puls / CO2 conc. / temp. 

F_1pctCO2 = 'no'   #CMIP5, 1pctCO2; Figs: temp.

F_RCP26C  = 'yes'   #CMIP5, RCP26 from conc.; Figs: temp.
F_RCP45C  = 'yes'   #CMIP5, RCP45 from conc.; Figs: temp.
F_RCP60C  = 'yes'   #CMIP5, RCP60 from conc.; Figs: temp.
F_RCP85C  = 'yes'   #CMIP5, RCP85 from conc.; Figs: temp.
F_RCP26E  = 'yes'   #CMIP5, RCP26 from emi.; Figs: temp. / CO2 conc.
F_RCP45E  = 'yes'   #CMIP5, RCP45 from emi.; Figs: temp. / CO2 conc.
F_RCP60E  = 'yes'   #CMIP5, RCP60 from emi.; Figs: temp. / CO2 conc.
F_RCP85E  = 'yes'   #CMIP5, RCP85 from emi.; Figs: temp. / CO2 conc.
...
F_MRCPE   = 'no'  #plot mass in three reservoirs for different hist+RCPs, emissions as input
...
#CMIP5, historical plus RCP, mass in differnt reservoirs, emissions as input
if (F_MRCPE == 'yes'):
    ...
    td.PlotResMassGtC(df_26, df_45, df_60, df_85,axis_range=[1850.,2100.,250.,2000.],skip_simu=[0,2,3,4,5,6,7,8,9],fout="CMIP_ResMass_RCP_EMI_GtC_DICE_new.png", leg='yes')
    td.PlotResMassGtC(df_26, df_45, df_60, df_85,axis_range=[1850.,2100.,250.,2000.],skip_simu=[0,2,3,4,5,6,7,8,9],fout="CMIP_ResMass_RCP_EMI_GtC_DICE_orig.png", leg='no')
