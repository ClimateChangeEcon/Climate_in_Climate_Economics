...
############################ FEX = original #################################################
### READING THE DATA from new climate
...
### READING THE DATA for surrogate gams (DEQN simulation)
path_gams = '/home/alexmalova/Documents/dummy_repo_CDICE/DEQN_for_IAMs/dice_generic/optimal_results/dice2016/'
...
############################ FEX = alternative #################################################
### READING THE DATA from new climate
path = '/home/alexmalova/Documents/dummy_repo_CDICE/DEQN_for_IAMs/dice_generic_FEX/appendix_results/CDICE_FEX/'
...
### READING THE DATA for surrogate gams (DEQN simulation)
path_gams = '/home/alexmalova/Documents/dummy_repo_CDICE/DEQN_for_IAMs/dice_generic_FEX/appendix_results/DICE2016_FEX/'
...
# ax.set_title("Damages, optimal abatement case")
de = 'Omega'
de_new = def_new[de]
de_gams = def_gams[de]
...
ax.plot(x, de_new[0:tl], color='blue', ls='solid', label='CDICE')
ax.plot(x, de_gams[0:tl], color='black', ls='solid', label='DICE-2016')
ax.plot(x, de_new_FEX[0:tl], color='#F41C8F', ls='solid', label='CDICE-FEX')
ax.plot(x, de_gams_FEX[0:tl], color='#8CB912', ls='solid', label='DICE-2016-FEX')
...
# ax.set_title("Mass of carbon in the atmosphere, optimal abatement case")
de = 'MATx'
